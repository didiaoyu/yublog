                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">用户信息修改</span>
                            </div>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" data-parsley-validate="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" readonly class="form-control" id="info_username" value="{{ $name }}" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="info_email" name="info[email]" placeholder="请输入邮箱"
                                                       required data-parsley-type="email" value="{{ $email }}"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="info_password" class="col-sm-2 control-label no-padding-right">密码</label>
                                            <div class="col-sm-10">
                                                <input type="password" class="form-control" name="info[password]" id="info_password" placeholder="不修改密码请留空" />
                                            </div>
                                        </div>
                                        <div class="form-group">
